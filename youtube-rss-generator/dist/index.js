 ...
 */
async function batchGenerateRSSFeeds(urls, validate = true, continueOnError = true) {
    const results = [];
    let successCount = 0;
    let failureCount = 0;
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        switch (name) {
            ...
            case 'batch_generate_rss_feeds': {
                const { urls, validate = true, continueOnError = true } = args;
