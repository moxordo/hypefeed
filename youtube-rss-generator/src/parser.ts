...
export class YouTubeURLParser {
   ...
   */
  static async generateRSSUrl(parsed: ParsedYouTubeURL): Promise<string | null> {
    if (!parsed.id) {
      return null;
    }
   ...
   */
  private static async getChannelFromVideo(videoId: string | null): Promise<string | null> {
   ...
   */
  private static async getChannelFromPlaylist(playlistId: string | null): Promise<string | null> {
   ...
   */
  private static async resolveChannelId(parsed: ParsedYouTubeURL): Promise<string | null> {
   ...
   * Fetch a web page
   */
  private static fetchPage(url: string): Promise<string> {
