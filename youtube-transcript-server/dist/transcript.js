export class YouTubeTranscript {
     ...
     */
    static async fetchVideoInfo(videoId) {
     ...
     */
    static async fetchTranscript(captionUrl) {
        try {
     ...
     */
    static findBestTrack(tracks, lang = 'en') {
     ...
     */
    static formatTranscript(entries, options) {
     ...
     */
    static async retrieve(videoId, options = {}) {
        try {
